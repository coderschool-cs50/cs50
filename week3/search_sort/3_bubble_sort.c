/* Please review this theory section before moving on to the code. Cheers! 🎉
    https://cdn.cs50.net/2017/fall/shorts/bubble_sort/bubble_sort.pdf
*/
...
/*
 * Objective: Implement the bubble_sort function to sort an array of integers in ascending order.
 *
 * Function Signature:
...
// Implement the bubble sort function here
void bubble_sort(int arr[], int size)
{
...
void test_bubble_sort()
{
    ...
    run_test("test_bubble_sort_simple", arr1, 5, expected1, 5);

    int arr2[] = {10, 1, 7, 3, 8};
    int expected2[] = {1, 3, 7, 8, 10};
    run_test("test_bubble_sort_unsorted", arr2, 5, expected2, 5);

    int arr3[] = {1, 2, 3, 4, 5};
    int expected3[] = {1, 2, 3, 4, 5};
    run_test("test_bubble_sort_already_sorted", arr3, 5, expected3, 5);

    int arr4[] = {5, 4, 3, 2, 1};
    int expected4[] = {1, 2, 3, 4, 5};
    run_test("test_bubble_sort_reverse_sorted", arr4, 5, expected4, 5);

    int arr5[] = {3, 3, 3, 3};
    int expected5[] = {3, 3, 3, 3};
    run_test("test_bubble_sort_all_same", arr5, 4, expected5, 4);
}
