...
void run_test(const char* test_name, int result) {
    if (result) {
...
void test_count_letters() {
    ...
    run_test("test_count_letters_only_letters", count_letters("Hello") == 5);
    run_test("test_count_letters_mixed", count_letters("Hello, World!") == 10);
    run_test("test_count_letters_non_letters", count_letters("12345!@#$%") == 0);
    run_test("test_count_letters_upper_lower", count_letters("AbCdEfG") == 7);
    run_test("test_count_letters_long_text", count_letters("This is a longer sentence with 32 letters.") == 32);
}
